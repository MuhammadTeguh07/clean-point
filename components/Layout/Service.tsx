        ...
        <div className="container-service">
            <div className="service">
                <div className="flex flex-col gap-3 pb-14">
                    <div className={`title-service`}>Tentang Kami</div>
                    <div className={`title-tagline`}>Apa itu CleanPoint ?</div>
                    <div className={`title-service`}>CleanPoint merupakan jasa cuci sepatu premium yang berlokasi di Surabaya dan Gresik. Kami menawarkan layanan perawatan sepatu profesional dengan hasil bersih, rapi, dan tahan lama, sehingga sepatu kesayanganmu selalu siap menunjang penampilan terbaik</div>
                </div>
                ...
                <div className={`sub-title-tagline`}>Kenapa Harus CleanPoint ?</div>
